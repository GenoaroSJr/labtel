...
const MyNav = ({ func, en, visited,setVisited }) => {
  ...
  useEffect(() => {
    const create = "https://api.countapi.xyz/create?namespace=labtel.unifei.edu.br&key=visitors&value=0"
    const get = "https://api.countapi.xyz/get/labtel.unifei.edu.br/visitors"
    const increment = "https://api.countapi.xyz/update/labtel.unifei.edu.br/visitors?amount=1"
  ...
  <Navbar collapseOnSelect bg="dark" variant="dark" sticky="top" expand="lg">
    ...
    <Navbar.Collapse id="responsive-navbar-nav">
      ...
      <span style={{color: '#fff',marginRight: 40, fontSize:12}}>Visitantes: {vis}</span>
      <img
        onClick={func}
        alt="bandeira"
        src={
